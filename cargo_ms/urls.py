...
urlpatterns = [
    ...
    path('iot/', include('iot_sensors.urls')),
    path('ai/', include('ai_intelligence.urls')),
    path('fleet/', include('fleet_intelligence.urls')),
    path('risk/', include('risk_management.urls')),
    path('cross-border/', include('cross_border.urls')),
    path('saas/', include('saas_config.urls')),
    path('integrations/', include('webhooks_integration.urls')),
    path('channels/', include('access_channels.urls')),
